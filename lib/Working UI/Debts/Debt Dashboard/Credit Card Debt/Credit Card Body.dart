...
import 'Payment Schedule.dart';
import 'Payoff Plan.dart';
import 'Record Payment.dart';

// ----------------------------
// DEBT DETAIL SCREEN
// ----------------------------

class CreditCardDebtDetailedScreen extends StatefulWidget {
  const CreditCardDebtDetailedScreen({super.key});

  @override
  State<CreditCardDebtDetailedScreen> createState() => _CreditCardDebtDetailedScreenState();
}

class _CreditCardDebtDetailedScreenState extends State<CreditCardDebtDetailedScreen> {
  @override
  void initState() {
    super.initState();
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      await CreditCardDebtLogic().buildScheduleAndSave(months: 120);
    });
  }
          ...
          child: Column(
            ...
            children: [
              ...
              AddContent(
                ...
                callback: () => Get.to(() => const CreditPaymentScheduleScreen()),
              ...
              AddContent(
                ...
                callback: () => Get.to(() => const CreditRecordPaymentScreen()),
              ),
              SizedBox(height: height * .01),
              AddContent(
                title: "View Payoff Plan",
                subTitle: "Projection + debt-free date",
                callback: () => Get.to(() => const CreditPayoffPlanScreen()),
                icon: Icons.calendar_month_rounded,
              ),
              SizedBox(height: height * .01),
              ...
              DarkCard(
                child: Column(
                  children: [
                    ...
                    // _DetailRow(
                    //     label: "Due Day",
                    //     value: d.dueDayOfMonth == null ? "None" : "${d.dueDayOfMonth}${CreditCardDebtDetailedScreen._suffix(d.dueDayOfMonth!)}"),
                    divider(),
        ...
        children: [
          ...
          Row(
            children: [
              ...
              //   child: textWidget(
              //     text:
              //         "Next: ${money(debt.minPayment)} • Due ${debt.dueDayOfMonth == null ? "None" : "${debt.dueDayOfMonth}${CreditCardDebtDetailedScreen._suffix(debt.dueDayOfMonth!)}"}",
              //     fontSize: .016,
              //     fontWeight: FontWeight.w700,
              //     color: ProjectColors.whiteColor.withOpacity(.75),
              //   ),
