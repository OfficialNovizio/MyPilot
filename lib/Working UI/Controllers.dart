...
import 'Debts/Debt Dashboard/Debt Getx V2.dart';
import 'Debts/Debt Getx.dart';
import 'Debts/Expenses/Expenses Getx V2.dart';
import 'Debts/Expenses/Expenses Getx.dart';
import 'Debts/Expenses/Expense Insight Logic V2.dart';
import 'Login User/Login Getx.dart';
...
final DebtsController debtV2 = Get.put(DebtsController());
// final ExpensesGetxController expense = Get.put(ExpensesGetxController());
final CardsAndAccount cards = Get.put(CardsAndAccount());
final LoginGetx login = Get.put(LoginGetx());
final ExpensesControllerV2 expenseV2 = Get.put(ExpensesControllerV2());
